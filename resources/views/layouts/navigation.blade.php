<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    <!-- Primary Navigation Menu -->
     <!-- Sucursal Info -->
                ...
                <div  class="text-blue-600 justify-center uppercase font-bold ">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if(Auth::check() && Auth::user()->hasAnyPermission(['ver lista roles', 'ver lista usuarios', 'gestionar dispositivos acceso', 'ver panel monitoreo dispositivos', 'ver log accesos']))
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="left" width="56">
                        ...
                        <x-slot name="content">
                            ...
                            @endcan
                            @can('ver panel monitoreo dispositivos') {{-- Asumiendo que tienes esta ruta nombrada así --}}
                            <x-dropdown-link :href="route('admin.panel.monitoreo.dispositivos')" :active="request()->routeIs('admin.panel.monitoreo.dispositivos')">
                                {{ __('Panel Monitoreo Disp.') }}
                            </x-dropdown-link>
                            @endcan
                            @can('ver log accesos') {{-- Asumiendo que tienes esta ruta nombrada así --}}
                            <x-dropdown-link :href="route('admin.informes.accesos')" :active="request()->routeIs('admin.informes.accesos')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @can('ver dashboard general')
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboar')">
                {{ __('Dashboard') }}
        ...
        @if(Auth::check() && Auth::user()->hasAnyPermission(['ver lista roles', 'ver lista usuarios', 'gestionar dispositivos acceso', 'ver panel monitoreo dispositivos', 'ver log accesos']))
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    @endcan
                    @can('ver panel monitoreo dispositivos')
                        <x-responsive-nav-link :href="route('admin.panel.monitoreo.dispositivos')" :active="request()->routeIs('admin.panel.monitoreo.dispositivos')">
                            {{ __('Panel Monitoreo Disp.') }}
                        </x-responsive-nav-link>
                    @endcan
                    @can('ver log accesos')
                        <x-responsive-nav-link :href="route('admin.informes.accesos')" :active="request()->routeIs('admin.informes.accesos')">
                            {{ __('Informe de Accesos') }}
                        </x-responsive-nav-link>
                    @endcan
                </div>
